            ...
            <h2 class="text-lg font-medium mr-auto">
                <!-- <div class="intro-y box"> -->
                    <div class="p-5" id="blank-modal">
                        <div class="preview">
                            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#superlarge-modal-size-preview" class="button inline-block bg-theme-1 text-white">Add New</a> </div>
                                <div class="modal" id="superlarge-modal-size-preview">
                                    <div class="modal__content modal__content--xl p-5 text-center">
                                        ...
                                        <form action="#">
                                            <div class="p-5 grid grid-cols-12 gap-4 row-gap-4">
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Date Name </label>
                                                    <input type="text" class="input w-full border mt-2 flex-1" placeholder="">
                                                </div>
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Warehouse</label>
                                                ...
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">supplier</label>
                                                    <select class="input w-full border mt-2 flex-1">
                                                        <option>10</option>
                                                        <option>25</option>
                                                        <option>35</option>
                                                ...
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Product</label>
                                                    <select class="input w-full border mt-2 flex-1">
                                                        <option>10</option>
                                                        <option>25</option>
                                                        <option>35</option>
