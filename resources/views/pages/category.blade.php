...
<div class="content">
                                            ...
                                            @csrf
                                                <div class="p-5 grid grid-cols-12 gap-6 row-gap-6">
                                                    <div class="col-span-12 md:col-span-12">
                                                        ...
                                                        <input type="text" class="input w-full border mt-2" placeholder="Category Name" name="category" required>
                                                        @error('name')
                                                    ...
                                                    <div class="col-span-12 md:col-span-12">
                                                        ...
                                                        <input type="text" class="input w-full border mt-2" placeholder="Description" name="description" id="description" required>
                                                    </div>
                                                </div>
                                            <div class="px-5 py-3 text-right border-t border-gray-200">
                                                <!-- <button type="button" data-dismiss="modal" class="button w-20 border text-gray-700 mr-1">Cancel</button> -->
                                                <button type="submit" id="submit" class="button w-20 bg-theme-1 text-white">Add</button>
                                            </div>
                                        </form>
                                    </div>
                            </div>
    ...
    <div class="intro-y datatable-wrapper box p-5 mt-5">
        <table class="table table-report table-report--bordered display datatable w-full dataTable no-footer dtr-inline" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 806px;">
            <thead>
                <tr role="row"><th class="border-b-2 whitespace-no-wrap sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 166px;" aria-sort="ascending" aria-label="PRODUCT NAME: activate to sort column descending">CATEGORY NAME</th>
                <th class="border-b-2 text-center whitespace-no-wrap sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 80px;" aria-label="IMAGES: activate to sort column ascending">IMAGES</th>
                <th class="border-b-2 text-center whitespace-no-wrap sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 124px;" aria-label="REMAINING STOCK: activate to sort column ascending">DESCRIPTION</th>
                ...
                <th class="border-b-2 text-center whitespace-no-wrap sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 116px;" aria-label="ACTIONS: activate to sort column ascending">ACTIONS</th></tr>
            </thead>
            <tbody>
