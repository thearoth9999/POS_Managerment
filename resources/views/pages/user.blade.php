                                        ...
                                        <form action="#">
                                            <div class="p-5 grid grid-cols-12 gap-6 row-gap-6">
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Full Name</label>
                                                    <input type="text" class="input w-full border mt-2 flex-1" placeholder="Full Name">
                                                </div>
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Date Of Birth</label>
                                                    <input type="text" class="input w-full border mt-2 flex-1" placeholder="Date Of Birth">
                                                </div>
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Username</label>
                                                    <input type="text" class="input w-full border mt-2 flex-1" placeholder="Username">
                                                </div>
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Phone number</label>
                                                    <input type="text" class="input w-full border mt-2 flex-1" placeholder="Phone number">
                                                </div>
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Password</label>
                                                    <input type="text" class="input w-full border mt-2 flex-1" placeholder="Password">
                                                </div>
                                                <div class="col-span-12 md:col-span-6">
                                                    <label class="font-medium text-base mr-auto">Confirm Password</label>
                                                    <input type="text" class="input w-full border mt-2 flex-1" placeholder="Confirm Password">
                                                </div>
